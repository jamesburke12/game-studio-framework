...
Confirm with `ask the user (see docs/vendor-map.md)`:
...
If the check passes, use `ask the user (see docs/vendor-map.md)` before creating the branch:
...
Use dispatch a subagent (see docs/vendor-map.md) to request sign-off in parallel:
