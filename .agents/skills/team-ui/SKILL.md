...
Then use `ask the user (see docs/vendor-map.md)` with options:
...
- Which engine UI framework should be used for this screen? (e.g., UI Toolkit vs UGUI in Unity — settled as UGUI by ADR-027)
