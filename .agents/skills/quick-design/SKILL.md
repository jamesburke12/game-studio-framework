...
Present the inferred classification using `ask the user (see docs/vendor-map.md)`:
...
Present the draft to the user in full. Then use `ask the user (see docs/vendor-map.md)`:
