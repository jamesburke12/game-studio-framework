...
Otherwise, use `ask the user (see docs/vendor-map.md)` to confirm intent before proceeding:
...
Assess which path best fits the hypothesis, then use `ask the user (see docs/vendor-map.md)` with your
...
2. **Choose path** — same ask the user (see docs/vendor-map.md) widget as Phase 3 (HTML / Engine / Paper).
