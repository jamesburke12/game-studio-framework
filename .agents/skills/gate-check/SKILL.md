...
- [ ] Test framework initialized: `assets/Tests/unit/` and `assets/Tests/integration/` directories exist
...
- [ ] Test files exist in `assets/Tests/unit/` and `assets/Tests/integration/` covering Logic and Integration stories
- [ ] All Logic stories from this sprint have corresponding unit test files in `assets/Tests/unit/`
...
After the verdict is presented and any stage.txt update is complete, close with a structured next-step prompt using `ask the user (see docs/vendor-map.md)`.
