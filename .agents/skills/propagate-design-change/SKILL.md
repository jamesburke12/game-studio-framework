...
- **CONCERNS** → surface the specific ADRs or recommendations flagged; use `ask the user (see docs/vendor-map.md)` with options: `Revise the impact assessment` / `Accept with noted concerns` / `Discuss further`
