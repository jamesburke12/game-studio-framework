...
If the project appears fresh (no artifacts at all), use `ask the user (see docs/vendor-map.md)`:
...
and offer to handle it immediately using `ask the user (see docs/vendor-map.md)`. Choose the first
branch that applies:
