...
Use `ask the user (see docs/vendor-map.md)` to batch-verify. Keep to at most 3 calls.
...
- Use `ask the user (see docs/vendor-map.md)` for all manual smoke check verification.
