...
Use `ask the user (see docs/vendor-map.md)` to confirm proceeding or reduce scope.
...
- **Broader regression** — run targeted tests in `assets/Tests/unit/` and `assets/Tests/integration/` for affected systems
