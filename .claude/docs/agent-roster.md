...
<!-- The Godot specialists were deleted 2026-08-28 (TASK #0564): this project is
     Unity only, and a roster naming agents that do not exist routes work to
     nothing. See .claude/agents/ for what actually exists. -->
